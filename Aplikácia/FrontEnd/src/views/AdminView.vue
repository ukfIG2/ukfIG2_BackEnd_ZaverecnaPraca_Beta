...
import Image_table from '../components/Tables/Image.vue'
...
export default {
  ...
  data() {
    return {
      selectedTable: 'Conference_table', // Default table
    }
  },
  computed: {
    tables() {
      return this.$options.components ? Object.keys(this.$options.components) : [];
    }
  }
}
</script>